...
Repository-specific guidance for coding agents working in this repo. Keep this file semantically aligned with `CLAUDE.md`; if a rule is not tool-specific, update both files in the same change.
